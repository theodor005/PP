...
int main(int argc, char* argv[]) {
    ...
    if(comanda == "help"){
      cout << "Comenzi:" << endl
      << "Pentru a vedea toate articolele: ./app1.exe vizualizare_articole" << endl
      << "Pentru a adauga un nou articol: ./app1.exe adaugare_articol <cod_de_articol> <titlu> <continut>" << endl
      << "Pentru a sterge un articol: ./app1.exe stergere_articol <cod_de_articol>" << endl
      << "Pentru a modifica un articol: ./app1.exe modificare_articol <cod_de_articol> <titlu> <continut>" << endl;
        ...
        string cod = argv[2];
        auto articole = loadArticole();
        articole.erase(remove_if(articole.begin(), articole.end(),[&](const Articol& articol) { return articol.getCod() == cod; }), articole.end());
        saveArticole(articole);
